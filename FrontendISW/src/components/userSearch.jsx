...
function UserSearch() {
    ...
    const handleSearch = async () => {
        ...
        try {
        const response = await axios.get(`http://146.83.198.35:1725/user/verUsuario/${userId}`);
    ...
    const handleUnassign = async () => {
        try {
        await axios.delete(`http://146.83.198.35:1725/as/${userId}/desasignarAS`);
    ...
    const handleAssign = async () => {
        try {
            ...
            const response = await axios.post('http://146.83.198.35:1725/as/as-to-user', {
                userId: user._id
            }, {
                headers: {
